...
* R-squared is `r round(summary(inf_lm)$adj.r.squared,4) ` and Adjusted R-squared is `r round(summary(inf_lm)$r.squared,4)` 
...
kbl(sum2, booktabs = T, caption = "Regression of Y1, ") %>% 
  kable_styling(latex_options = c("striped", "HOLD_position"))
