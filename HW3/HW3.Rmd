...
Visual Exam. To assess if the lines are indeed parallel, i.e. the slopes are the same, we need to work with predictor variable, 
...
Get slope, and variance of slopes
...
$$ \Large weight_i = \frac{1}{se(\hat \beta_{i})}$$
...
Conclusion on relative potency
