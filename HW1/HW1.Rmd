...
Standard Error of difference = $\sqrt{\frac{SD_{smokers}^2}{N_{smokers}} + \frac{SD_{non-smokers}^2}{N_{non-smokers}}}$
...
Step one is to obtain a coefficient from Ficher Transformation
...
The last step is to transform back from Ficher Z back to the original scale
